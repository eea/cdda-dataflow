...
(:
 : Module Name: CDDA 2015 - Sites (Main module)
 :
 : Version:     $Id$
 ...
 :)
(:~
 : XQuery script for CDDA 2015 - Sites table.
 ...
 : XML Schema:  http://dd.eionet.europa.eu/GetSchema?id=TBL9120
 :
...
(:
 ...
 TEST files:
 declare variable $source_url as xs:string external;
 declare variable $source_url := "../test/cdda_sites-2015.xml";
 :)
(:~ DD table ID :)
declare variable $xmlconv:SCHEMA_ID as xs:string :=  $rules:SITES_SCHEMA;
(:~ DD table elements namespace prefix :)
declare variable $xmlconv:ELEM_SCHEMA_NS_PREFIX as xs:string :=  $rules:SITES_NS_PREFIX;
