...
(:
 : Module Name: CDDA 2015 - Designation boundaries (Main module)
 :
 : Version:     $Id$
 ...
 :)
(:~
 : XQuery script for CDDA 2015 - Designation boundaries table.
...
(:
 TEST files:
 declare variable $source_url as xs:string external;
 declare variable $source_url := "../test/cdda_desigboundaries-2015.xml";
 :)
(:~ DD table ID :)
