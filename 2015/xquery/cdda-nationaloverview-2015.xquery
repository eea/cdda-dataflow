...
(:
 : Module Name: CDDA 20 - National overview (Main module)
 :
 : Version:     $Id$
 : Created:     2 January 20
 : Copyright:   European Environment Agency
 :)
(:~
 : XQuery script for CDDA 20 - National overview table.
...
as element(div)
{
    let $ruleResults := (
        ...
        , xmlutil:executeDuplicatesCheck($url, $xmlconv:SCHEMA_ID, $xmlconv:ELEM_SCHEMA_NS_PREFIX, $xmlconv:KEY_ELEMENT, "2",
            ("PARENT_ISO", "ISO3", "Category", "Major_ecosystem"), false())
